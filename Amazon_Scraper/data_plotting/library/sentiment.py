...
# Specify the file name (assuming it's in the same directory as the script)
filename = 'SentiWordNet.txt'
...
s = SentimentAnalysis(filename=full_path,weighting='geometric')
